...
,p_name=>'File upload calibration'
,p_alias=>'FILE-UPLOAD-CALIBRATION'
,p_page_mode=>'MODAL'
,p_step_title=>'File upload calibration'
...
,p_last_upd_yyyymmddhh24miss=>'20230926151254'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5776897630223254)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3148016968087912)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5776897630223254)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3148396200087911)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3148808477087911)
,p_name=>'P97_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5776897630223254)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3149175102087909)
,p_name=>'P97_ERR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5776897630223254)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3149642425087908)
,p_validation_name=>'file browse not null'
,p_validation_sequence=>10
,p_validation=>'P97_FILE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Select File'
,p_when_button_pressed=>wwv_flow_api.id(3148396200087911)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3150735178087906)
,p_name=>'HIDE GLOBAL'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3151237961087906)
,p_event_id=>wwv_flow_api.id(3150735178087906)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3149993146087908)
...
'begin',
'',
' IF (:P97_FILE is not null) THEN',
'    arr := apex_util.string_to_table(:P97_FILE);',
...
'         ',
'          apex_util.set_session_state(''P97_ERR'',''File ''||FILENAME||'' should not be greater than 5mb'');',
'',
'     raise e_error;',
'         ',
'      else',
...
'                              );',
'            else',
'             apex_util.set_session_state(''P97_ERR'',''Only *Pdf , *jpeg,* png,*jpeg type files are allowed'');',
'',
'           raise e_error;',
'            ',
'            end if;',
...
,p_process_error_message=>'&P97_ERR.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(3148396200087911)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3150334916087907)
