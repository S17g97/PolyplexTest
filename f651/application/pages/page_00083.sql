...
,p_name=>'Finalize revision download'
,p_alias=>'FINALIZE-REVISION-DOWNLOAD'
,p_step_title=>'Finalize revision download'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'SHRUTI'
,p_last_upd_yyyymmddhh24miss=>'20230825152242'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41816943949462921)
,p_plug_name=>'Report'
...
'select -4 NU_BLOCK , ''TIME_BLOCK'' v_block , ''TIME_DESC'' nu_to , ''QUANT_RN_RNX'' nu_quant_rn_rnx from dual',
'union',
'  select NU_BLOCK, to_char(NU_BLOCK) v_block, NU_FROM||''-''||NU_TO Time_dec , to_char(NU_QUANT_RN)',
...
'--    and NU_DOC_DATE = b.NU_DOC_DATe and NU_BLOCK = b.NU_BLOCK   AND VC_AMENDMENT_NO IS NOT NULL),0))) tot_NU_QUANT',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(41817110369462923)
...
,p_owner=>'SHRUTI'
,p_internal_uid=>60169977756725248
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1761399221536187)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1761740948536186)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1762177144536186)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1760950833536188)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(41903150208810984)
