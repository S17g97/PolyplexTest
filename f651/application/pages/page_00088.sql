...
,p_name=>'Invoice Multiple JMR List '
,p_alias=>'INVOICE-MULTIPLE-JMR-LIST'
,p_step_title=>'Invoice Multiple JMR List '
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'SHRUTI'
,p_last_upd_yyyymmddhh24miss=>'20230530123059'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(243706166856344049)
,p_plug_name=>'Invoice With Multiple JMR List'
...
,p_prn_page_header=>'Invoice With Multiple JMR List'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(244165317948461344)
...
,p_owner=>'AKSHAY1'
,p_internal_uid=>262518185335723669
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42167656755969099)
,p_db_column_name=>'EDIT'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'&nbsp'
,p_column_link=>'f?p=&APP_ID.:87:&SESSION.::&DEBUG.:87:P87_MODE,P87_INVOICE_NO,P87_INVOICE_DATE,P87_LAST_PAGE,P87_AUTH_FLAG:E,#VC_INVOICE_NO#,#DT_INVOICE_DATE#,29,#CH_AUTH_FLAG#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42167301441969099)
,p_db_column_name=>'VIEW1'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'&nbsp'
,p_column_link=>'f?p=&APP_ID.:87:&SESSION.::&DEBUG.:87:P87_MODE,P87_INVOICE_NO,P87_INVOICE_DATE,P87_LAST_PAGE,P87_AUTH_FLAG:V,#VC_INVOICE_NO#,#DT_INVOICE_DATE#,29,#CH_AUTH_FLAG#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42166903619969098)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42166510163969097)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42166034574969097)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42165673444969096)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42165331449969096)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42164889741969095)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42164524868969094)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42168516702969100)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42168059375969100)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(244274281961531956)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(42169144376969102)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(243706166856344049)
...
,p_button_redirect_url=>'f?p=&APP_ID.:87:&SESSION.::&DEBUG.:87:P87_MODE:A'
