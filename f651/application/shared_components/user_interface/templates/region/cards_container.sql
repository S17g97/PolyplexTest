...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16314832777492172)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(15653187575510040)
,p_plug_template_id=>wwv_flow_api.id(16314832777492172)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(15653319122510040)
,p_plug_template_id=>wwv_flow_api.id(16314832777492172)
,p_name=>'Sub Regions'
